...
const WebScrapingProject = () => {
  ...
  return (
    <motion.div
    >
      <div className=" bg-gray-800 rounded-xl border  border-gray-700 overflow-hidden shadow-xl transition-all duration-300  hover:border-orange-600">
        ...
        <div className="relative overflow-hidden h-48">
          ...
          <div className="absolute top-4 left-4">
            <div className="bg-gray-900/90 p-2 rounded-lg">
              <FiServer className="text-orange-400" />
            </div>
          </div>
          ...
          <div className="mb-4">
            <div className="flex flex-wrap gap-2">
              {project.technologies.map((tech, index) => (
                <span
                  key={index}
                  className="px-3 py-1 bg-orange-900/20 text-orange-300 rounded-full text-xs font-medium"
                >
                  {tech}
                </span>
              ))}
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-orange-900/20 p-2 rounded">
                <p className="text-xs font-medium text-white">Rate Limiting</p>
                <p className="text-xs text-gray-400">Prevents API abuse</p>
              </div>
              <div className="bg-blue-900/20 p-2 rounded">
                <p className="text-xs font-medium text-white">CORS Protection</p>
                <p className="text-xs text-gray-400">Secure requests</p>
              </div>
            </div>
          </div>
